...
\begin{frame}{PS8, Ex. 5.b: Winner's Curse}
      ...
      \vspace{-10pt}
      \begin{itemize}
        \item[Step 3:] Use $(*)$ to write up the expected value of the oil-field after receiving the report $r_1=H$ where the profits can be either high $v_H$ or low $v_L$.
      \end{itemize}
      \vfill\null
\end{frame}
\begin{frame}{PS8, Ex. 5.b: Winner's Curse}
      ...
      \vspace{-6pt}
      \begin{align*}
        \mathbb{E}[v|r_1=H]=\mathbb{P}[H|r_1=H]v_H+\mathbb{P}[L|r_1=L]v_L=pv_H+(1-p)v_L
      \end{align*}
      \vfill\null
\end{frame}
...
\begin{frame}{PS8, Ex. 5.c: Winner's Curse}
      ...
      \begin{align*}
        ...
        &=\frac{1}{2}v_H+\frac{1}{2}v_L<\underbrace{pv_H+(1-p)v_L}_{\textstyle\mathbb{E}[v|r_1=H]}&&\text{since }p>\frac{1}{2}
      \end{align*}
      \vspace{-14pt}
      \begin{itemize}
...
\begin{frame}{PS8, Ex. 5.c: Winner's Curse}
      ...
      \begin{align*}
        \mathbb{E}[v|r_1&=H\wedge win]=\mathbb{P}[H|r_1=H\wedge win]v_H+\mathbb{P}[L|r_1=L\wedge win]v_L\\
        &=H\wedge win]=\mathbb{P}[H|r_1=H\wedge win]v_H+\left(1-\mathbb{P}[H|r_1=H\wedge win]\right)v_L\\
        &=\frac{1}{2}v_H+\frac{1}{2}v_L<pv_H+(1-p)v_L\text{   since   }p>\frac{1}{2}
      \end{align*}
      \vspace{-14pt}
      \begin{itemize}
