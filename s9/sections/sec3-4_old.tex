\section{PS9, Ex. 3': Solving 3.b and 3.c through integration (optional)}

\begin{frame}{PS9, Ex. 3.b': Solving 3.b through integration (optional)}
    \begin{multicols}{2}
      \begin{itemize}
...
\begin{frame}{PS9, Ex. 3.c': Solving 3.c through integration (optional)}
    \begin{multicols}{2}
      \begin{itemize}
...
\begin{frame}{PS9, Ex. 3.c.i': Solving 3.c through integration (optional)}
    \begin{multicols}{2}
      \begin{itemize}
        \item[(c)] Suppose now that the object is sold by a \textit{second-price sealed bid auction}.
        \begin{itemize}\normalsize
...
\begin{frame}{PS9, Ex. 3.c.ii': Solving 3.c through integration (optional)}
    \begin{multicols}{2}
      \begin{itemize}
        \item[(c)] Suppose now that the object is sold by a \textit{second-price sealed bid auction}.
        \begin{itemize}\normalsize
...
\begin{frame}{PS9, Ex. 3.c.iii': Solving 3.c through integration (optional)}
    \begin{multicols}{2}
      \begin{itemize}
        \item[(c)] Suppose now that the object is sold by a \textit{second-price sealed bid auction}.
        \begin{itemize}\normalsize
...
\section{PS9, Ex. 4': Solving 4.c through integration (optional)}

\begin{frame}{PS9, Ex. 4.c': Solving 4.c through integration (optional)}
    \begin{itemize}
