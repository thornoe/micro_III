...
% Select what to do with command \issue:
  \newcommand{\issue}[1]{\bfseries \color{red} #1} % issues shown
  % \newcommand{\issue}[1]{}  % issues not shown
...
\title{Microeconomics III: Problem Set 9\footnote{Slides created for exercise class 3 and 4, with reservation for possible errors.\\}}
