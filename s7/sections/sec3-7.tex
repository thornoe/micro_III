...
Now, look for a threatening strategy which if followed will lead to the combination.
  \vfill\null\columnbreak
  \vfill\null
  \end{multicols}
    \vfill\null
...
\begin{frame}{PS7, Ex. 5.b: Trigger strategy (infinitely repeated game)}
  ...
  \begin{multicols}{2}
    ...
    \begin{enumerate}
        ...
        \item $U_2(Cl,DCl) = 6$
        \item $U_2(DCl,DCl) = 1$
        \item Algebra of infinite sequences:\\
...
\begin{frame}{PS7, Ex. 6.c: Tit-for-tat strategy (infinitely repeated game)}
  ...
  \begin{multicols}{2}
  \begin{itemize}
      \item[] Define the payoff for staying with the tit-for-tat strategy, and for deviating. Then write up the inequality and isolate $\delta$ to find for what values of $\delta$ player 2 wouldn't deviate, you only need to check P2 as P2 has the highest incentive to deviate.
  \end{itemize}
    \vfill\null\columnbreak
    \begin{enumerate}
        \item $U_2(Cl,Cl) = 4$
