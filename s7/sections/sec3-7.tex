...
\begin{frame}{PS7, Ex. 3.a (A): A single stage game NE (finitely repeated game)}
    ...
    \vspace{10pt}
    Explanation: \\
    \intuition{In the last round, an NE from the stage game must be played. In this case there is only one NE, which is (A,D). Knowing that (A,D) will be played no matter what in the \nth{2} round, no player has an incentive to cooperate in the \nth{1} turn. Player A will play his dominant strategy A and player B will play her dominant strategy D.}
    \vfill\null    
\end{frame}
...
Now, look for a threatening strategy which if abode by will lead to the combination. Threatening that the players will go for the (Y,B) NE rather than (C,Z) in the \nth{2} stage if (A,X) is not the outcome of stage 1.\\
\vspace{10pt}
...
\begin{frame}{PS7, Ex. 6.d: Tit-for-tat strategy (infinitely repeated game)}
    ...
    Could other deviations be better?
    \vfill\null
\end{frame}
\begin{frame}{PS7, Ex. 6.d: Tit-for-tat strategy (infinitely repeated game)}
    Consider again the the infinitely repeated game $G(\infty,\delta)$ with the stage game:
