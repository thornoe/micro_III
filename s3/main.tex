...
\begin{frame}{PS4, Ex. 2 extra: Game tree with choices off the equilibrium path}
  \begin{multicols}{2}
    \begin{itemize}
      \item[(a)] What is the solution now?
    \end{itemize}
    \textbf{Looking at the new branch}: If Firm 2 chooses to do some market research in the \nth{1} round, then Firm 1 can choose to either sabotage the research, or do nothing in the \nth{2} round.\\\medskip
    \textbf{Firm 1} will always sabotage, as it will gain more than by doing nothing $(1>0)$.\\\medskip
    Knowing that Firm 1 is rational and will choose to sabotage in the \nth{2} round, \textbf{Firm 2} (first mover), would get 0 by doing market research in the \nth{1} round, so to enter in the \nth{1} round will be the best response $(1>0)$, i.e. the backwards induction solution is the strategy profile:
      \begin{align*}
...
\section{PS3, Ex. 7: Mixed Strategy Nash Equilibria - best-response functions}
...
\begin{frame}{PS3, Ex. 7: Mixed Strategy Nash Equilibria - best-response functions}
  ...
  \end{tabular}
\end{frame}
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
  \begin{multicols}{2}
    \begin{itemize}
...
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
  ...
  \end{multicols}
\end{frame}
\begin{frame}{PS3, Ex. 7.b: Mixed Strategy Nash Equilibria - best-response functions}
  \begin{multicols}{2}
    \begin{itemize}
