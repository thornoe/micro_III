...
\begin{frame}{PS3, Ex. 3 (A): NE proof using IEWDS}
  ...
  \begin{multicols}{2}
    ...
    \textbf{IESDS:} If a strategy was strongly dominated there would be a clear incentive to deviate from it, thus, by definition the strategy could not be a NE.
  \vfill\null\columnbreak
  \textbf{IEWDS:} In a NE where a player $A$ is indifferent between the NE-payoff and her payoff from deviating, the NE-strategy can be weakly dominated if player $A$'s' alternative strategy would give a higher payoff in the case where player $B$ deviates from his NE strategy as well.
  \vfill\null
  \end{multicols}
\end{frame}
\begin{frame}{PS3, Ex. 3 (A): NE proof using IEWDS}
  ...
  \begin{multicols}{2}
    ...
    \textbf{IESDS:} If a strategy was strongly dominated there would be a clear incentive to deviate from it, thus, by definition the strategy could not be a NE.
  \vfill\null\columnbreak
    \textbf{IEWDS:} In a NE where a player $A$ is indifferent between the NE-payoff and her payoff from deviating, the NE-strategy can be weakly dominated if player $A$'s' alternative strategy would give a higher payoff in the case where player $B$ deviates from his NE strategy as well.\\\medskip
...
\section{PS3, Ex. 8: Mixed Strategy Nash Equilibria - best-response functions}
