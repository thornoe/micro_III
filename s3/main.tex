...
\begin{frame}{PS3, Ex. 6: Cournot Oligopoly with three firms}
  ...
  \vfill\null \columnbreak
    ...
    \begin{align*}
        \pi_i&=(1-q_i-q_j)q_i
    \end{align*}
    BR function for firm $i$ in the duopoly in the duopoly:
    \begin{align*}
        q_i&=\frac{1-q_j}{2}\\
        q_i^{*} &= \frac{1-2q_i^{*}}{2},\ \ \ q_i^{*}=q_j^{*}\\
        q_i^{*} &= \frac{1}{3}\equiv q^{NE}
...
\begin{frame}{PS3, Ex. 8: Mixed Strategy Nash Equilibria}
  Find all (pure and mixed) Nash equilibria in the following game:
    ...
    \begin{enumerate}
      ...
      \item Write up the \textbf{best responses for Player 2}: $\left(q_1^{*}(p),q_2^{*}(p)\right)$, i.e.
      \begin{align*}
        BR_2(p)=\left\{ \begin{array}{ll}
            \vdots                  & \vdots  \\
            \{(0,q_2):q_2\in[0,1]\} & p = 2/3 \\
            (0,0)                   & p > 2/3 \\
        \end{array}\right.
      \end{align*}
      \item The \textbf{NE} (pure and mixed) are where the BR's intersect.
    \end{enumerate}
  \vfill\null
\end{frame}
...
\begin{frame}{PS3, Ex. 8: Mixed Strategy Nash Equilibria}
  ...
  \vfill\null \columnbreak
    ...
    \begin{align*}
      ...
      p       &= \frac{1}{3}
    \end{align*}
    For $p<\frac{1}{3}$ prefer $L$; if $p>\frac{1}{3}$ prefer $C$.\\\medskip
    ...
    \begin{align*}
      ...
      p       &= \frac{1}{2}
    \end{align*}
    For $p<\frac{1}{2}$ prefer $L$; if $p>\frac{1}{2}$ prefer $R$.\\\medskip
    Player 2 is indifferent between $C$ and $R$ if:
    \begin{align*}
      3p+2(1-p) = 4p \Leftrightarrow 2 = 3p \Leftrightarrow p = \frac{2}{3}
    \end{align*}
    For $p<\frac{2}{3}$ prefer $C$; if $p>\frac{2}{3}$ prefer $R$.\\\medskip
  \vfill\null
  \end{multicols}
\end{frame}
