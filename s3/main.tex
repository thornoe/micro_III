...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \end{itemize}
    \textbf{Starting from the bottom}: If Firm 2 has entered the market in the \nth{1} round, then Firm 1 can choose to either fight or accommodate in the \nth{2} round.\\\medskip
    \textbf{Firm 1} will always accommodate, as it is more  costly to fight.
  \vfill\null \columnbreak
    \begin{figure}[!h]
      \begin{center}
      \def\svgwidth{1.0\columnwidth}
...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \textbf{Intuition:} Firm 2 has \textit{first mover advantage}, thus, it would not be credible if Firm 1 threatens to fight. Using backwards induction, the problem for Firm 2 can be reduced to the upper part of the game tree, given Firm 1 is rational.
  \vfill\null \columnbreak
    \begin{figure}[!h]
      \begin{center}
      \def\svgwidth{1.0\columnwidth}
