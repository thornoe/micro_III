...
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
  \begin{multicols}{2}
    ...
    \begin{table}
      ...
      \end{tabular}
    \end{table}
    For which values of $q$ are Player 1 indifferent between playing $T$ and $B$?
  \vfill\null \columnbreak
  \vfill\null
  \end{multicols}
\end{frame}
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
  \begin{multicols}{2}
    ...
    \end{itemize}
    What is Player 1's best-response function?
  \vfill\null \columnbreak
  \vfill\null
  \end{multicols}
\end{frame}
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
  \begin{multicols}{2}
    ...
    \begin{itemize}
      ...
      \item Prefers $B$ if $q<1\Rightarrow p=0$.
    \end{itemize}
    Player 1's best-response (BR) function, $p^{*}(q)$, is:
    \begin{align*}
      BR_1(q)=
    ...
    \end{align*}
  \vfill\null \columnbreak
    Now, try to plot Player 1's BR function in a "(p,q)-diagram".
  \vfill\null
  \end{multicols}
\end{frame}
\begin{frame}{PS3, Ex. 7.a: Mixed Strategy Nash Equilibria - best-response functions}
