...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \end{itemize}
  \vfill\null \columnbreak
    Whoops, I'll have to turn it upside down:
    \begin{figure}[!h]
      \begin{center}
...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \begin{itemize}
      \item[(b)] Solve the game by backwards induction.
    \end{itemize}
    Starting from the bottom: If Firm 2 has entered in the \nth{1} round, then Firm 1 can choose to either fight or accommodate in the \nth{2} round.\\\medskip
    \textbf{Firm 1} will always accommodate, as it's too costly to fight.
  \vfill\null \columnbreak
    \begin{figure}[!h]
      \begin{center}
      \def\svgwidth{1.0\columnwidth}
...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \begin{itemize}
      \item[(b)] Solve the game by backwards induction.
    \end{itemize}
    \textbf{Starting from the bottom}: If Firm 2 has entered in the \nth{1} round, then Firm 1 can choose to either fight or accommodate in the \nth{2} round.\\\medskip
    \textbf{Firm 1} will always accommodate, as it's too costly to fight $(1>0)$.\\\medskip
...
\begin{frame}{PS4, Ex. 2: Entry deterrence in a game tree}
  \begin{multicols}{2}
    ...
    \textbf{Starting from the bottom}: If Firm 2 has entered in the \nth{1} round, then Firm 1 can choose to either fight or accommodate in the \nth{2} round.\\\medskip
    \textbf{Firm 1} will always accommodate, as it's too costly to fight $(1>0)$.\\\medskip
    Knowing that Firm 1 is rational and will accommodate in the \nth{2} round, \textbf{Firm 2} (first mover), will always chose to enter in the \nth{1} round $(1>0)$.\\\medskip
    \textbf{Intuition:} Firm 2 has \textit{first mover advantage}, thus, it would not be credible if Firm 1 threatens to "Fight".
  \vfill\null \columnbreak
    \begin{figure}[!h]
      \begin{center}
      \def\svgwidth{1.0\columnwidth}
