...
\begin{frame}{PS12, Ex. 2.c (A): Farrell \& Rabin (1996). Discuss if PBE is reasonable?}
    ...
    \vfill\null
\end{frame}
% OPDEL PÅ FLERE SLIDES!
% Skriv besked ud: Piazza, no question lesson (fjern i lokaleadmn!), use slides on front page (errors are fixed and somethings are explained in greater detail),  
