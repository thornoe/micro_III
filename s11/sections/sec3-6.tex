...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      \begin{itemize}
        \item[Step 1:] Consider S's possible strategies:\vspace{-8pt}\begin{align*}S_\text{S}=\{(L,L);(R,R);(L,R);(R,L)\} \end{align*}\vspace{-20pt}
      \end{itemize}
      \vfill\null\columnbreak
      \begin{figure}[!h]
        \center
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \end{itemize}\vspace{-10pt}
        \begin{align*}
          \mathbb{E}[u_\text{R}(R,u|p=\frac{1}{2})]&=\frac{1}{2}2+\frac{1}{2}0=1\\
          \mathbb{E}[u_\text{R}(R,d|p=\frac{1}{2})]&=\frac{1}{2}0+\frac{1}{2}1=\frac{1}{2}
        \end{align*}\vspace{-18pt}
      \begin{itemize}
        \item[SR2S:] S: $t_2$ wants to deviate as $L|t_2$ is strictly dominated by $R|t_2$.
        \item[PBE:]  Not a PBE as $t_2$ would deviate.
