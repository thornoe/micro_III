...
\subsection{PS11, Ex. 4.b: Signaling game (pooling and separating PBE)}
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_LL.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $S_\text{S}=\{(L,L);(R,R);(L,R);(R,L)\}$
      \end{enumerate}
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_LL_uu.pdf_tex}
      \end{figure}
      \vfill\null
    \end{multicols}
\end{frame}
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_RR.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_RR_u.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_LR.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_LR_du.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
...
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    ...
    \begin{multicols}{2}
      ...
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_RL.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
...
\end{frame}
\begin{frame}{PS11, Ex. 4.b: Signaling games (pooling and separating PBE)}
    Exercise 4.4.b in Gibbons (p. 248). Describe all the pure-strategy pooling and separating perfect Bayesian equilibria in the following signaling game.\vspace{-10pt}
    \begin{multicols}{2}
      \begin{itemize}
        \item Consider S's possible strategies:\vspace{-6pt}\begin{align*}S_\text{S}=\{(L,L);(R,R);(L,R);(R,L)\} \end{align*}\vspace{-16pt}
        \item[Step 1:] For the pooling strategy (\textit{L,L}), go over SR3, SR2R, and SR2S.
        \item[Step 2:] For the pooling strategy (\textit{R,R}), go over SR3, SR2R, and SR2S.
        \item[Step 3:] For the separating strategy (\textit{L,R}), go over SR3, SR2R, and SR2S.
      ...
      \begin{itemize}
        \item[SR2R:] R: Best response is to play $u|L,d|R$.
        \item[SR2S:] \vspace{-1pt}$t_1$ will not deviate as
      \end{itemize}\vspace{-12pt}
      \begin{align*}
        u_\text{S}(R,d|t_1)=4>3=u_\text{S}(L,u|t_1)
      \end{align*}\vspace{-21pt}
      \begin{itemize}
        \item[] $t_2$ will not deviate as
      \end{itemize}\vspace{-12pt}
      \begin{align*}
        u_\text{S}(L,u|t_2)=3>2=u_\text{S}(R,d|t_2)
      \end{align*}\vspace{-21pt}
      \begin{itemize}
        \item[PBE:] No deviation, thus, it's a PBE.
        \item[Step 5:] \vspace{-1pt}\textbf{Write up the full set of PBE.}
      \end{itemize}
      \vfill\null\columnbreak
      \begin{figure}[!h]
        \center\def\svgwidth{1.1\columnwidth}
        \import{figures/}{Gibbons_4_4_b_RL_ud.pdf_tex}
      \end{figure} \vspace{-8pt}
      \begin{enumerate}
        \item $\left\{\begin{array}{c}
            (L,L),(u,u),p=\frac{1}{2},q\leq\frac{2}{3}\end{array}\right\}$
