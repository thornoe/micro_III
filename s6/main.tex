...
\intuition{The difference comes from the fact that the collusion in the first stage drives down the cost, the benefit of which is then distributed amongst companies and consumers}
\vfill\null
\end{frame}
