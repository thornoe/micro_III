\section{PS10, Ex. 7: Dissolving a partnership (Perfect Bayesian Equilibria)}
    ...
    \begin{multicols}{2}
      ...
      \begin{align*}
          \mathbb{E}[u_1(v_1,p)]
            ...
            &=ps-v_1s\textcolor{red}{-p^2s}+\textcolor{red}{pv_1s}+pv_1\textcolor{red}{-pv_1s}-p^2+\textcolor{red}{p^2s}\\
            &=ps-v_1s+pv_1-p^2  &&(*)
      \end{align*}
      \vfill\null\columnbreak
      \begin{enumerate}
...
\begin{frame}{PS10, Ex. 7: Dissolving a partnership (Perfect Bayesian Equilibria)}
    ...
    \begin{multicols}{2}
      \begin{itemize}
        \item[Step 1:] Write up the cumulative distribution function (CDF) for a uniform distribution $x\sim U(a, b)$, and the probability that a random draw of $x$ is lower than a constant $c$.
        \item[Step 2:] P1's expected utility from price \textit{p}.
        \item[Step 3:] \textbf{Find the PBE price $\bm{p^*}$ by maximizing P1's expected utility $\bm{(*)}$ with respect to the price \textit{p}.}
      \end{itemize}\vspace{-8pt}
      \vfill\null\columnbreak
      \begin{enumerate}
        \item Standard result for $x\sim U(a, b):$
...
\begin{frame}{PS10, Ex. 7: Dissolving a partnership (Perfect Bayesian Equilibria)}
    ...
    \begin{multicols}{2}
      \begin{itemize}
        \item[Step 1:] Write up the cumulative distribution function (CDF) for a uniform distribution $x\sim U(a, b)$, and the probability that a random draw of $x$ is lower than a constant $c$.
        \item[Step 2:] P1's expected utility from price \textit{p}.
        \item[Step 3:] Find the PBE price $p^*$ by maximizing P1's expected utility $(*)$ with respect to the price \textit{p}.
      \end{itemize}
      \vfill\null\columnbreak
      \begin{enumerate}
        \item Standard result for $x\sim U(a, b):$
